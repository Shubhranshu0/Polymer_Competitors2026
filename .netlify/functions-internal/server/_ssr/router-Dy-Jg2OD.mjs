...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Dy-Jg2OD.js
...
var styles_default = "/assets/styles-D6B90cu1.css";
var APP_NAME = "Halene Polymer Grade Book";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Technical data sheets for Halene HDPE, LLDPE and PP grades — typical properties, processing and BIS codes in a two-column grade book."
			}
		],
		links: [
			{
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500&family=IBM+Plex+Sans:ital,wght@0,400;0,500;0,600;1,400&family=IBM+Plex+Serif:ital,wght@0,500;0,600;1,500&display=swap"
			}
		]
	}),
...
var $$splitComponentImporter = () => import("./routes-CjLb0ff5.mjs");
